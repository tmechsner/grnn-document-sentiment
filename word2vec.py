...
data_imdb = pd.read_csv('emnlp-2015-data/imdb-train.txt.ss', sep="    ", header=None, engine='python',
                        names=["full_review"])
data_yelp = pd.read_csv('emnlp-2015-data/yelp-2015-train.txt.ss', sep="    ", header=None, engine='python',
                        names=["full_review"])
